 ...
 * 
 */
@WebServiceClient(name = "Gateway", targetNamespace = "http://apps.sertifi.net/services/", wsdlLocation = "https://sandbox.sertifi.net/jaketest/Services/Gateway.asmx?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://sandbox.sertifi.net/jaketest/Services/Gateway.asmx?wsdl");
     ...
     *     returns GatewaySoap
     */
    @WebEndpoint(name = "GatewaySoap12")
    public GatewaySoap getGatewaySoap12() {
        return super.getPort(new QName("http://apps.sertifi.net/services/", "GatewaySoap12"), GatewaySoap.class);
    }
     ...
     */
    @WebEndpoint(name = "GatewaySoap12")
    public GatewaySoap getGatewaySoap12(WebServiceFeature... features) {
        return super.getPort(new QName("http://apps.sertifi.net/services/", "GatewaySoap12"), GatewaySoap.class, features);
    }
