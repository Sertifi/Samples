 ...
 *         &lt;element name="pstr_PdfID" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "AddPrepopulatedPdfToRequest")
public class AddPrepopulatedPdfToRequest {

    @XmlElement(name = "pstr_APICode")
    protected String pstrAPICode;
    @XmlElement(name = "pstr_FileID")
    protected String pstrFileID;
    @XmlElement(name = "pstr_PdfID")
    protected String pstrPdfID;
    ...
    /**
     * Gets the value of the pstrPdfID property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getPstrPdfID() {
        return pstrPdfID;
    }

    /**
     * Sets the value of the pstrPdfID property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setPstrPdfID(String value) {
        this.pstrPdfID = value;
    }
